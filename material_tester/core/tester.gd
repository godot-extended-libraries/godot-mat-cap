...
var hdrs=[
	{ path="res://material_tester/art/environment/schelde.hdr", name="Riverside"},
	{ path="res://material_tester/art/environment/lobby.hdr", name="Lobby"},
	{ path="res://material_tester/art/environment/park.hdr", name="Park"},
	{ path="res://material_tester/art/environment/night.hdr", name="Night"},
	{ path="res://material_tester/art/environment/experiment.hdr", name="Experiment"},
]
